...
import {
  AssignTicketInterface,
  PicActionTicketInterface,
} from "../features/work-request-features/types/work-request-type";
...
export const getTicketNumberService = async (search: string): Promise<any> => {
  try {
    const response = await axiosGet(
      `/work-request/ticket-number?search=${search}`
    );
    return Promise.resolve(response);
  } catch (err: any) {
    return Promise.reject(err);
...
export const getTicketRequestService = async (search: string): Promise<any> => {
  try {
    const response = await axiosGet(
      `/work-request/ticket-request?search=${search}`
    );
    return Promise.resolve(response);
  } catch (err: any) {
    return Promise.reject(err);
...
export const getWorkRequestReceiveService = async (
  search: string
): Promise<any> => {
  try {
...
export const createWorkRequestService = async (
  payload: CreateWorkRequestFormInterface
): Promise<any> => {
  try {
...
export const headActionTicketService = async (
  payload: HeadActionTicketInterface
): Promise<any> => {
  try {
...
export const picActionTicketService = async (
  payload: PicActionTicketInterface
): Promise<any> => {
  try {
...
export const sendBackService = async (
  payload: SendBackToAssignee
): Promise<any> => {
  try {
...
export const getWorkRequestList = async (payload: {
  search: string;
  ticketStatus: string;
  type: string;
  department: string;
  ...
  try {
    const response = await axiosGet(
      `/work-request/all/ticketStatus/${payload.ticketStatus}/type/${payload.type}/department/${payload.department}/year/${payload.year}/month/${payload.month}?search=${payload.search}`
    );
    return Promise.resolve(response);
  } catch (err: any) {
    return Promise.reject(err);
...
export const getWorkRequestIssued = async () => {
  try {
    const response = await axiosGet(`/work-request/issued`);
    return Promise.resolve(response);
  } catch (err: any) {
    return Promise.reject(err);
  }
...
export const getWorkRequestComments = async (payload: string) => {
  try {
    const response = await axiosGet(
      `/work-request/comment/ticketId/${payload}`
    );
    return Promise.resolve(response);
  } catch (err: any) {
    return Promise.reject(err);
...
export const updateWorkRequestService = async (
  payload: EditWorkRequestInterface
) => {
  try {
