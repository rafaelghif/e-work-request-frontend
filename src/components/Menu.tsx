...
const MenuItemWorkRequestReceive = lazy(
  () => import("./MenuItemWorkRequestReceive")
);
    ...
    >
      ...
      <IonContent className="bg-slate-600">
        ...
        <div className="bg-slate-600">
          ...
          <MenuItemDropDown
            headerText="Ticket"
            headerIcon={documentAttachOutline}
          >
            <MenuItem
              url="/work-request-form"
              text="Create"
              icon={radioButtonOffOutline}
            />
            <MenuItem
              url="/work-request-form-edit"
              text="Edit"
              icon={radioButtonOffOutline}
            />
            <MenuItem
              url="/work-request-issued"
              text="Issued"
              icon={radioButtonOffOutline}
            />
          </MenuItemDropDown>
          <MenuItemDropDown
            headerText="Work Request"
            headerIcon={fileTrayFullOutline}
          >
            <Suspense fallback={<IonSpinner name="crescent" />}>
              <MenuItemTicketRequest
                user={user}
                url="/ticket-request"
                text="Approve"
                icon={radioButtonOffOutline}
            ...
            <Suspense fallback={<IonSpinner name="crescent" />}>
              <MenuItemWorkRequestReceive
                user={user}
                url="/work-request-receive"
                text="Receive"
                icon={radioButtonOffOutline}
              />
            </Suspense>
          </MenuItemDropDown>
          <MenuItemDropDown headerText="Report" headerIcon={readerOutline}>
            <MenuItem
            ...
            />
            <MenuItem
              url="/work-request-list-old"
              text="Work Request Old"
              icon={radioButtonOffOutline}
            />
          </MenuItemDropDown>
