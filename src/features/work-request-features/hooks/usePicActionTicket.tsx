...
import { picActionTicketService } from "../../../services/work-request-service";
import { PicActionTicketInterface } from "../types/work-request-type";

const usePicActionTicket = () => {
    const dispatch = useAppDispatch();
    const dispatch2 = useDispatch<any>();
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: (payload: PicActionTicketInterface) => picActionTicketService(payload),
        onMutate: () => {
...
export default usePicActionTicket;